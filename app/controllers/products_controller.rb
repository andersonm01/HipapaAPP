class ProductsController < ApplicationController
  before_action :require_admin_or_supervisor, only: [:new, :create, :edit, :update, :destroy]
  before_action :set_product, only: [:show, :edit, :update, :destroy]

  def index
    @products = Product.with_attached_foto.order(created_at: :desc)
  end
  ...
  def product_params
    params.require(:product).permit(:nombre, :descripcion, :precio, :categoria, :activo, :posicion, :foto)
  end
end
