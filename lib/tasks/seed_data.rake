namespace :db do
  desc "Seed database with production data via SQL"
  task seed_data: :environment do
    puts "🌱 Sembrando datos de producción..."

    # Admin user
    User.find_or_create_by!(email: 'admin@hipapa.com') do |user|
    ...
    # Productos
    products_data = [
      { nombre: 'La Toxica Grande', descripcion: 'Chicharrón, guacamole, sour cream, ripio de tostinachos, huevos de codorniz, papas a la francesa y salsas al gusto', precio: 28_000, categoria: 'Papas', posicion: 1 },
      { nombre: 'La Prohibida Grande', descripcion: 'Carne BBQ desmechada, guacamole, queso mozzarella, maicitos, huevos de codorniz, papas a la francesa y salsas al gusto', precio: 28_000, categoria: 'Papas', posicion: 2 },
      { nombre: 'La Tragona Grande', descripcion: 'Carne BBQ desmechada, pollo desmechado, sour cream, huevos de codorniz, papas a la francesa y salsas al gusto', precio: 28_000, categoria: 'Papas', posicion: 3 },
      { nombre: 'La Humilde Grande', descripcion: 'Tocineta, queso mozzarella, huevos de codorniz, papas a la francesa y salsas al gusto', precio: 22_000, categoria: 'Papas', posicion: 4 },
      { nombre: 'La Toxica Personal', descripcion: 'Chicharrón, guacamole, sour cream, ripio de tostinachos, huevos de codorniz, papas a la francesa y salsas al gusto', precio: 17_500, categoria: 'Papas', posicion: 5 },
      { nombre: 'La Prohibida Personal', descripcion: 'Carne BBQ desmechada, guacamole, queso mozzarella, maicitos, huevos de codorniz, papas a la francesa y salsas al gusto', precio: 17_500, categoria: 'Papas', posicion: 6 },
      { nombre: 'La Tragona Personal', descripcion: 'Carne BBQ desmechada, pollo desmechado, sour cream, huevos de codorniz, papas a la francesa y salsas al gusto', precio: 17_500, categoria: 'Papas', posicion: 7 },
      { nombre: 'La Humilde Personal', descripcion: 'Tocineta, queso mozzarella, huevos de codorniz, papas a la francesa y salsas al gusto', precio: 15_000, categoria: 'Papas', posicion: 8 },
    ...
    puts "✓ #{recipe_count} recetas creadas"
